...
locals {
  ...
  domain_name     = "staging-generate.everythingstudios.ai"
  assets_base_url = "https://staging-assets.everythingstudios.ai"
  webhook_url     = "https://staging.everythingstudios.ai/api/generate/webhook"
